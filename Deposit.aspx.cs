...
public partial class Deposit : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            con.Open();
            SqlCommand com = new SqlCommand("insert into Deposit values('" + TextBox1.Text + "','" + DateTime.Now.ToShortDateString() + "','" + DateTime.Now.ToShortTimeString() + "','" + TextBox2.Text + "'," + decimal.Parse(TextBox3.Text) + ")", con);
            ...
            SqlCommand com1 = new SqlCommand("insert into ATransaction values('" + TextBox1.Text + "','" + DateTime.Now.ToShortDateString() + "','" + DateTime.Now.ToShortTimeString() + "'," + decimal.Parse(TextBox3.Text) + ",'C')", con);
            com1.ExecuteNonQuery();
            ...
            Label1.Text = "Deposited Successfully";
            TextBox1.Text = "";
            TextBox2.Text = "";
            TextBox1.Focus();
        }
