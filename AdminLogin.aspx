      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-5 ml-auto" data-aos="fade-up" data-aos-delay="100">
            <form id="admin" class="p-5 bg-white" runat="server">
              ...
              <div class="row form-group">
                ...
                <div class="col-md-12">
                  ...
                  <asp:TextBox ID="TextBox1" runat="server" class="form-control" MaxLength="5"></asp:TextBox>
                </div>
              </div>
              ...
              <div class="row form-group">
                ...
                <div class="col-md-12">
                  ...
                  <asp:TextBox ID="TextBox2" runat="server" class="form-control" MaxLength="5" 
