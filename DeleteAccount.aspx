                ...
                <div class="col-md-12">
                  <asp:GridView ID="GridView1" runat="server" BackColor="White" 
                            ...
                            <asp:TemplateField HeaderText="Delete">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lnkDelete" CommandName="Delete" runat="server" OnClientClick="return confirm('Do You want Delete?')">Delete</asp:LinkButton>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                <asp:BoundField DataField="Accoundno" HeaderText="AccoundNumber" />
